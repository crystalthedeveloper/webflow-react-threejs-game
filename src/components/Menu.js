    ...
    <div className="menu">
      ...
      {showInstructions && (
        <p className="instructions">
          Use the arrow keys to move.<br />  Collect items and achieve the best time to win! <span className="good-luck">1st</span> place winner earns <br /> <span className="good-luck">$$$</span> <span className="good-luck">Good luck!</span>
        </p>
      )}
